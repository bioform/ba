...
func (_m *ErrorMapWrapper) Cause() ba.ErrorMap {
	ret := _m.Called()
	...
	var r0 ba.ErrorMap
	if rf, ok := ret.Get(0).(func() ba.ErrorMap); ok {
		r0 = rf()
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(ba.ErrorMap)
		}
	}
...
func (_c *ErrorMapWrapper_Cause_Call) Return(_a0 ba.ErrorMap) *ErrorMapWrapper_Cause_Call {
	_c.Call.Return(_a0)
	return _c
}

func (_c *ErrorMapWrapper_Cause_Call) RunAndReturn(run func() ba.ErrorMap) *ErrorMapWrapper_Cause_Call {
	_c.Call.Return(run)
	return _c
}
