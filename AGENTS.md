...
This file provides guidance to AI coding agents (Claude Code, Cursor, GitHub Copilot, and other
tools that read the [`AGENTS.md`](https://agents.md) convention) when working with code in this
repository.
