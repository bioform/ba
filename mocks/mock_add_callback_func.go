...
func (_m *AddCallbackFunc) Execute(callback ba.AfterCommitCallback) {
	_m.Called(callback)
}
...
//   - callback ba.AfterCommitCallback
...
func (_c *AddCallbackFunc_Execute_Call) Run(run func(callback ba.AfterCommitCallback)) *AddCallbackFunc_Execute_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(ba.AfterCommitCallback))
	})
	return _c
}
...
func (_c *AddCallbackFunc_Execute_Call) RunAndReturn(run func(ba.AfterCommitCallback)) *AddCallbackFunc_Execute_Call {
	_c.Run(run)
	return _c
}
