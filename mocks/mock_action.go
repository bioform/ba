...
func (_m *Action) AfterCommitCallback() ba.AfterCommitCallback {
	ret := _m.Called()
	...
	var r0 ba.AfterCommitCallback
	if rf, ok := ret.Get(0).(func() ba.AfterCommitCallback); ok {
		r0 = rf()
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(ba.AfterCommitCallback)
		}
	}
...
func (_c *Action_AfterCommitCallback_Call) Return(_a0 ba.AfterCommitCallback) *Action_AfterCommitCallback_Call {
	_c.Call.Return(_a0)
	return _c
}

func (_c *Action_AfterCommitCallback_Call) RunAndReturn(run func() ba.AfterCommitCallback) *Action_AfterCommitCallback_Call {
	_c.Call.Return(run)
	return _c
}
...
// ContextUpdated provides a mock function with no fields
func (_m *Action) ContextUpdated() {
	_m.Called()
}

// Action_ContextUpdated_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'ContextUpdated'
type Action_ContextUpdated_Call struct {
	*mock.Call
}

// ContextUpdated is a helper method to define mock.On call
func (_e *Action_Expecter) ContextUpdated() *Action_ContextUpdated_Call {
	return &Action_ContextUpdated_Call{Call: _e.mock.On("ContextUpdated")}
}

func (_c *Action_ContextUpdated_Call) Run(run func()) *Action_ContextUpdated_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run()
	})
	return _c
...
func (_c *Action_ContextUpdated_Call) Return() *Action_ContextUpdated_Call {
	_c.Call.Return()
	return _c
}

func (_c *Action_ContextUpdated_Call) RunAndReturn(run func()) *Action_ContextUpdated_Call {
	_c.Run(run)
	return _c
}
...
func (_m *Action) Performer() ba.Performer {
	ret := _m.Called()
	...
	var r0 ba.Performer
	if rf, ok := ret.Get(0).(func() ba.Performer); ok {
		r0 = rf()
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(ba.Performer)
		}
	}
...
func (_c *Action_Performer_Call) Return(_a0 ba.Performer) *Action_Performer_Call {
	_c.Call.Return(_a0)
	return _c
}

func (_c *Action_Performer_Call) RunAndReturn(run func() ba.Performer) *Action_Performer_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_m *Action) SetPerformer(_a0 ba.Performer) {
	_m.Called(_a0)
}
...
func (_c *Action_SetPerformer_Call) Run(run func(_a0 ba.Performer)) *Action_SetPerformer_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(ba.Performer))
	})
	return _c
}
...
func (_c *Action_SetPerformer_Call) RunAndReturn(run func(ba.Performer)) *Action_SetPerformer_Call {
	_c.Run(run)
	return _c
}

// TransactionProvider provides a mock function with no fields
func (_m *Action) TransactionProvider() ba.TransactionProvider {
	ret := _m.Called()
	...
	var r0 ba.TransactionProvider
	if rf, ok := ret.Get(0).(func() ba.TransactionProvider); ok {
		r0 = rf()
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(ba.TransactionProvider)
		}
	}
...
func (_c *Action_TransactionProvider_Call) Return(_a0 ba.TransactionProvider) *Action_TransactionProvider_Call {
	_c.Call.Return(_a0)
	return _c
}

func (_c *Action_TransactionProvider_Call) RunAndReturn(run func() ba.TransactionProvider) *Action_TransactionProvider_Call {
	_c.Call.Return(run)
	return _c
}
