// AfterCommit callback registration and execution. Callbacks fire only after
// the action's transaction successfully commits; panics inside callbacks are
// captured and surfaced as a CallbackError carrying a stack trace.
package ba
